    ...
    <div className="app-shell">
      ...
      <main className="main-content">
        ...
        <div className="page-wrap">
          {active === "overview" && <Overview members={members} present={present} totalCollected={totalCollected} setActive={setActive} addMember={addMember} match={match} setMatch={setMatch} />}
          {active === "attendance" && <Attendance members={members} attendance={attendance} selectedDate={selectedDate} setSelectedDate={setSelectedDate} toggleAttendance={toggleAttendance} />}
          {active === "funds" && <Funds members={members} funds={funds} setFunds={setFunds} totalCollected={totalCollected} />}
        </div>
      </main>
    </div>
  );
...
function Overview({ members, present, totalCollected, setActive, addMember, match, setMatch }) {
  const [form, setForm] = useState({ name: "", position: "" });
  const [matchForm, setMatchForm] = useState({ opponent: match?.opponent || "", date: match?.date || "" });
...
function Attendance({ members, attendance, selectedDate, setSelectedDate, toggleAttendance }) {
...
function Funds({ members, funds, setFunds, totalCollected }) {
